...
// 为了设置光标轨迹的颜色以匹配用户的光标颜色，你需要首先获取用户当前光标的颜色
const Color = "#fcd9eb" // If set to "default," it will use the theme's cursor color.
// 如果设置为"default"，它将使用主题的光标颜色。
// ! default will only reference editorCursor.background
// ! 默认只会引用editorCursor.background
// "workbench.colorCustomizations": {
//     "editorCursor.background": "#fcd9eb",
// }
...
// line选项使用fill()来绘制轨迹，block选项使用lineTo来绘制轨迹
...
function createTrail(options) {
  ...
  let particlesColor = options?.color || "#fcd9eb"
